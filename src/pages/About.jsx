...
function About() {
  return (
    <section className="about-page">
      ...
      <h1>The Heart Behind the Ink</h1>

      <p className="about-intro">
        Hi, I'm <strong>Shital Sapkal.</strong>
      </p>
      ...
      <p>
        ...
        an emotion I once felt, and every story holds a thought that once lived
        within me. Now, I want to share them with you. To every beautiful reader
        who finds a little piece of themselves in my words—
      ...
      <div className="about-ending">
        <p>This is my Ink.</p>
        <p>This is my Soul.</p>
        <p>And now, I am sharing it with you.</p>
      </div>
